...
extension UIControl {
    /// Creates a Combine publisher for UIControl events
    /// - Parameter events: The control events to observe
    /// - Returns: A publisher that emits Void when the specified events occur
